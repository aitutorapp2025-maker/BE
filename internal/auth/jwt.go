...
// GenerateAdminToken signs a JWT for the given admin, valid for ttl.
func GenerateAdminToken(secret string, ttl time.Duration, a model.Admin) (string, time.Time, error) {
